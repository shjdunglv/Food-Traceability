        ...
        <div class="col-md-5 center-block-e">
            ...
            <div class="login-form">
                ...
                <div class="login-form-inner">
                    ...
                    <p class="decent-margin small-text"><a href="<?php echo site_url("login/forgotpw") ?>"><?php echo lang("forgot_your_password") ?></a> <span class="pull-right"><a href="<?php echo site_url("register") ?>"><?php echo lang("register") ?></a></span></p>
                </div>
