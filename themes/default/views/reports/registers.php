...
if ($this->input->post('Company')) {
    $v .= "&user=" . $this->input->post('Company');
}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            echo form_dropdown('Company', $us, (isset($_POST['Company']) ? $_POST['Company'] : ""), 'class="form-control select2" id="user" data-placeholder="' . lang("select") . " " . lang("user") . '" style="width:100%;"');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                        ...
                        <div class="table-responsive">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="col-xs-1"><?= lang('Company'); ?></th>
                            ...
                            <tfoot>
                                <tr class="active">
                                    ...
                                    <th class="col-sm-1"><input type="text" class="text_filter" placeholder="[<?= lang('Company'); ?>]"></th>
                                    <th class="col-xs-1"><?= lang('cash_in_hand'); ?></th>
                                    <th class="col-xs-1"><?= lang('cc_slips'); ?></th>
                                    <th class="col-xs-1"><?= lang('cheques'); ?></th>
                                    <th class="col-xs-1"><?= lang('total_cash'); ?></th>
