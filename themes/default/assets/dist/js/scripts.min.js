function cActions() {
    1 == Settings.rtl ? $(".modal-content .select2").select2({
        ...
        dir: "rtl"
    }) : $(".modal-content .select2").select2({minimumResultsForSearch: 6}), $("input").iCheck({
        ...
        dragImageUpload: !1,
        dragFileUpload: !1
    }), $(":file").filestyle(), $(".validation").formValidation({framework: "bootstrap", excluded: ":disabled"})
}
...
function formatSA(t) {
    ...
    var a = (t = (t = Math.floor(t)).toString()).substring(t.length - 3), n = t.substring(0, t.length - 3);
...
function read_card() {
    $(".swipe").keypress(function (t) {
        var e = $(this).attr("id"), a = e.substr(e.length - 1), n = $(this).val();
        if (13 == t.keyCode) {
            t.preventDefault();
            var r = new SwipeParserObj(n);
            if (r.hasTrack1) {
                var o = null, i = r.account.charAt(0);
...
$(function () {
    ...
    cActions(), 1 == Settings.rtl ? $(".select2").select2({
        minimumResultsForSearch: 6,
        dir: "rtl"
    }) : $(".select2").select2({minimumResultsForSearch: 6}), $(document).on("click", '[data-toggle="ajax"]', function (t) {
        t.preventDefault();
    ...
    var e = Math.floor(t() / 1e3), a = date(dateformat + " " + timeformat, e);
